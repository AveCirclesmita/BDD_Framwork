package com.cjc.cucumber.Magento.Utility;  
...

{
	...
	public static void file_in() throws IOException
	{
	...
	public static void registrationMethod() throws IOException {
		fi = new FileInputStream("src//test//resources//Datapass_Excel//MaganetoShopping.xlsx");
